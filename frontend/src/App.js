...
// ******* favorite into dataBase
  ...
  return (
    ...
    <BrowserRouter>
        <div className="grid-container">
            <header className="row">
              ...
              <i className="fa fa-bars"></i>
                ...
                <div>
                    <Link to="/favorite/:id?"><i className="fa fa-heart" aria-hidden="true"></i>
                    ...
                    <span className="badge">{favoriteItems.length} </span>
                     ...
                     {/* ***** favorite */}
                    {/* <Link to="/favorite/:id?"><i className="fa fa-heart" aria-hidden="true"></i>
                    {favorateProducts.length > 0 && (
                      <span className="badge">{favorateProducts.length} </span>  
                    )}
                    </Link> */}
       ...
       <Route path="/favorite/:id?" component={FavoriteScreen} exact ></Route>
